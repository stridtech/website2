        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Drop-in replacement for ingress-nginx, with a familiar
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automatically renew SSL/TLS certificates before they expire,
                ensuring your site stays secure.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Azure Key Vault or Managed HSM Integration</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Securely fetch SSL/TLS certificates from Azure Key Vault or
                Managed HSM, without the need to store them in your cluster.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Customize the ingress controller to your needs with support for
                annotations, ConfigMaps, and Helm charts.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Deploy the ingress controller as a highly available Kubernetes
                Deployment with autoscaling capabilities.
              </p>
            </article>
          </div>
        </div>
